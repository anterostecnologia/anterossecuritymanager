export const SET_DATASOURCE_HORARIOS_ACESSO = 'SET_DATASOURCE_HORARIOS_ACESSO';
export const SET_FILTER_HORARIOS_ACESSO = 'SET_FILTER_HORARIOS_ACESSO';

export const actions = {
  setDatasource(dataSource) {
    return { type: SET_DATASOURCE_HORARIOS_ACESSO, payload: { dataSource } };
  },
  setFilter(activeFilter, query, sort, activeSortIndex, quickFilterText) {
    return {
      type: SET_FILTER_HORARIOS_ACESSO,
...
export default (
  ...
  switch (action.type) {
    case SET_DATASOURCE_HORARIOS_ACESSO: {
      return { ...state, dataSource: action.payload.dataSource };
    }
    case SET_FILTER_HORARIOS_ACESSO: {
      return {
        ...state,
