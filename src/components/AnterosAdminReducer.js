...
const actionTypes = {
    ...
    CHANGE_SUB_LAYOUT: 'CHANGE_SUB_LAYOUT',
    LAYOUT_TYPE: 'LAYOUT_TYPE',
    RESET: 'RESET',
    NAV_BACK_COLOR: 'NAV_BACK_COLOR',
    NAV_BRAND_COLOR: 'NAV_BRAND_COLOR',
...
const AnterosAdminReducer = (state = initialState, action) => {
    let trigger = [];
    let open = [];
...
export default AnterosAdminReducer;
export {
    actionTypes
};