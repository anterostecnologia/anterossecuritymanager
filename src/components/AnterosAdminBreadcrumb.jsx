...
@boundClass
class AnterosAdminBreadcrumb extends Component {
    state = {
        main: [],
        item: []
    };
    ...
    render() {
        ...
        if (this.state.main && this.state.main.type === 'collapse') {
            main = (
                <li className="breadcrumb-item">
                    <a href={config.BLANK_LINK}>{this.state.main.title}</a>
                </li>
            );
        }
        ...
        if (this.state.item && this.state.item.type === 'item') {
            ...
            item = (
                <li className="breadcrumb-item">
                    <a href={config.BLANK_LINK}>{title}</a>
                </li>
            );
...
export default AnterosAdminBreadcrumb;